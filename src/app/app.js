let app = angular.module('albi-eco-race', ['ngMockE2E', 'ngAnimate', 'ui.router', 'anim-in-out', 'ui.bootstrap', 'ngSanitize', 'pascalprecht.translate', 'angular-loading-bar', 'rx', 'timer']);
let languages = ['en', 'fr'];
